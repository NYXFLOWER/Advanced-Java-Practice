...
public class Task2A {
	...
	public static void main(String args[]) {
		Set<Person> people = new HashSet<Person>();// here we declare people to be the most general type, which makes it possible to swap HashSet for TreeSet.
		StringTokenizer st;
		...
		try {
			Scanner file = new Scanner(new File ("/Users/nyxfer/Documents/GitHub/Advanced-Java-Practice/WarmLab/src/Week8/Person.txt"));
		...
		while (i.hasNext()) {
			Person p = i.next();
			if ("James".equals(p.getSurname()) || "Cole".equals(p.getSurname())) {
