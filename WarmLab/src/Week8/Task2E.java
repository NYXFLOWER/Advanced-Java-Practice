...
public class Task2E {
	...
	public static void main(String args[]) {
		Set<Person> people = new TreeSet<Person>(new ReverseAgeComparator());// here we declare people to be the most general type, which makes it possible to swap HashSet for TreeSet.
		StringTokenizer st;
