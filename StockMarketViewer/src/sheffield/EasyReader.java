...
public class EasyReader extends BufferedReader {
	...
	/**
	* Create a new sheffield.EasyReader that reads from standard input
	*/
	public EasyReader() {
	...
	/**
	* Create a new sheffield.EasyReader that reads from a text file
	...
	*/
	...
	private static void error(String s) {
		System.err.println("Error in sheffield.EasyReader - "+s);
		System.err.flush();
		System.exit(0);
		}
